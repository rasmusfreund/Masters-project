...
ax1.set_title('LASSO Regression Coefficients as a Function of Regularization')
...
for idx, alpha in enumerate(lambdas_to_plot):
    ...
    lasso.fit(X_poly_scaled, y)
    y_fit = lasso.predict(scaler.transform(X_fit_poly))
...
save_path = "/mnt/c/Users/rasmu/Desktop/Bioinformatics/MSc/Thesis/img/lasso_lambda_effect.png"
